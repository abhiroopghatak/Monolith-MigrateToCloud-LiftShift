...
insert into Review (id, hotelid, username, review) values (1, 7, 'scott','Nice staff.Well managed services. Need to work over music in waiting lounge area')
insert into Review (id, hotelid, username, review) values (2, 7, 'erwin','Rooms are clean and maintained . morning view is amazing.')